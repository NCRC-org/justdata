#!/usr/bin/env python3
"""Standalone script to package LendSight - avoids PowerShell path issues."""
...
lendsight_src = repo_root / 'apps' / 'lendsight'

print("[*] Creating LendSight Deployment Package")
print(f"   Source: {lendsight_src}")
...
templates_src = lendsight_src / 'templates'
...
sql_templates_src = lendsight_src / 'sql_templates'
...
requirements_src = lendsight_src / 'requirements.txt'
