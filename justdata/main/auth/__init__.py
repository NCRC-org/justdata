...
# Register sub-blueprints. Imports happen here (after all helpers/decorators
# above are defined) so the route modules can `from justdata.main.auth import ...`
# at module load time without hitting partially-initialized state.
from justdata.main.auth.routes.login import login_bp  # noqa: E402
from justdata.main.auth.routes.users import users_bp  # noqa: E402
from justdata.main.auth.routes.organizations import organizations_bp  # noqa: E402
from justdata.main.auth.routes.sync import sync_bp  # noqa: E402

auth_bp.register_blueprint(login_bp)
auth_bp.register_blueprint(users_bp)
auth_bp.register_blueprint(organizations_bp)
auth_bp.register_blueprint(sync_bp)
