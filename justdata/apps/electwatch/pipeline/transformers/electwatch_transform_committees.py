"""ElectWatch pipeline: build the static committee data set (House Financial Services, Senate Banking, etc.)."""
import logging

logger = logging.getLogger(__name__)


def process_committees(coordinator):
    """Build committee data (mostly static but enriched with live stats)."""
    coordinator.committees_data = [
        {
    ...
    logger.info(f"Processed {len(coordinator.committees_data)} committees")
