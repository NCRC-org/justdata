// LenderProfile Report - section initializers (header, business strategy,
// risk factors, financial performance, M&A activity, regulatory risk,
// community investment, branch network, lending footprint, leadership,
// congressional trading, news, Seeking Alpha). Each function reads
// reportData.<section> and renders into pre-existing DOM. Moved verbatim
// from report_v2.js. Function bodies untouched.
...
import {
    ...
    formatDate,
    escapeHtml,
} from './lenderprofile_report_utils.js';
