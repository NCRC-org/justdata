...
@app.route('/api/census-tracts-by-state/<state_fips>')
...
@app.route('/api/branches-by-bank')
...
@app.route('/api/branches-in-bounds')
...
@app.route('/api/counties-in-bounds')
...
@app.route('/api/oscr-events-by-bank')
...
@app.route('/api/oscr-events-in-bounds')
