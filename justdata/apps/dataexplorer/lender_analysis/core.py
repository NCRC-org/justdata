"""Lender analysis orchestrator (run_lender_analysis).

The function uses inline state across many phases (loading data,
running peer queries, building section data, generating Excel exports).
It is preserved as a single function — only the surrounding helpers
have been extracted to filters / formatters / data_check / queries.
"""
import logging
...
from justdata.apps.dataexplorer.data_utils import get_peer_lenders, validate_years
...
from justdata.apps.dataexplorer.lender_analysis.formatters import (
    _format_all_metros_for_excel,
    _generate_peer_data_sheet_for_excel,
)
