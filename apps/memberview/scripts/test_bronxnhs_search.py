"""Test website search for Bronx NHS."""
import sys
...
print("Testing website search for Bronx Neighborhood Housing Services CDC Inc")
print("=" * 80)

enricher = WebsiteEnricher()

company_name = "Bronx Neighborhood Housing Services CDC Inc"
city = "Bronx"
state = "NY"
...
test_url = "https://www.bronxnhs.org/"
...
if is_likely:
    ...
    print(f"Would be accepted: {confidence >= 0.80}")
...
ddg_result = enricher._search_duckduckgo(company_name, city, state)
if ddg_result:
    print(f"DuckDuckGo found: {ddg_result[0]} (confidence: {ddg_result[1]:.2f})")
else:
    print("DuckDuckGo did not find website")
