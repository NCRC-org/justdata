"""Test website search for Entrepreneurship for All."""
import sys
...
print("Testing website search for Entrepreneurship for All")
print("=" * 80)

enricher = WebsiteEnricher()

company_name = "Entrepreneurship for All"
city = None
state = None
