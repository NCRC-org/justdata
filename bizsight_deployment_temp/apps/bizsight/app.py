...
from apps.bizsight.data_utils import get_available_counties, get_available_years
from apps.bizsight.utils.progress_tracker import (
...
def analyze():
    ...
    try:
        ...
        # Validate year range
        from apps.bizsight.data_utils import validate_year_range
...
def get_states():
    ...
    try:
        from apps.bizsight.data_utils import get_available_states
...
def get_tract_boundaries(geoid5):
    ...
    try:
        from apps.bizsight.utils.tract_boundaries import get_tract_boundaries_geojson
