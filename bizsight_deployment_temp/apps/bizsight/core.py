...
from apps.bizsight.report_builder import create_top_lenders_table, create_county_summary_table, create_comparison_table, calculate_hhi_by_year, calculate_hhi_for_lenders
...
def parse_web_parameters(county_data: dict, years_str: str) -> tuple:
    ...
    min_year = min(years)
    max_year = max(years)
    if min_year < 2018 or max_year > 2024:
        raise ValueError("Years must be between 2018 and 2024")
